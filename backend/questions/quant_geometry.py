...
def get_questions():
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=5, rating_explanation=5, rating_discrimination=4, rating_overall=4.71),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.2,
                                    ...
                                    correct_option="c",
                                    explanation_ar="Formula:\n Volume of the Cube = Edge³\n\nSubstitution:\n Volume = 3³ = 3 × 3 × 3 = 27 cm³\n\nWhy other options are wrong:\n            • (a) 90°: Result of Calculate Area of faces instead of 6 Lateral faces\n            • (c) 270°: Result of confusing Volume and Total surface area\n            • (d) 360°: Result of squaring Edge instead of cubing it or vice versa",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=4, rating_overall=4.57),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.3,
                                    ...
                                    correct_option="c",
                                    explanation_ar="Formula:\n Volume of the Cube = Edge³\n\nSubstitution:\n Volume = 5³ = 5 × 5 × 5 = 125 cm³\n\nWhy other options are wrong:\n            • (a) 16 cm: Result of Calculate Area of faces instead of 6 Lateral faces\n            • (c) 63 cm: Result of confusing Volume and Total surface area\n            • (d) 128 cm: Result of squaring Edge instead of cubing it or vice versa",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=4, rating_overall=4.57),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.4,
                                    ...
                                    correct_option="d",
                                    explanation_ar="Formula:\n Volume of the Cube = Edge³\n\nSubstitution:\n Volume = 6³ = 6 × 6 × 6 = 216 cm³\n\nWhy other options are wrong:\n            • (a) 22 cm: Result of Calculate Area of faces instead of 6 Lateral faces\n            • (c) 42 cm: Result of confusing Volume and Total surface area\n            • (d) 120 cm: Result of squaring Edge instead of cubing it or vice versa",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=4, rating_overall=4.57),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.4,
                                    ...
                                    correct_option="c",
                                    explanation_ar="Formula:\n Total surface area = 6 × Edge²\n\nSubstitution:\n        Area = 6 × 2² = 6 × 4 = 24 cm²\n\nWhy other options are wrong:\n            • (a) 3 cm: Result of Calculate Area of faces instead of 6 Lateral faces\n            • (b) 4 cm: Result of confusing Volume and Total surface area\n            • (d) 8 cm: Result of squaring Edge instead of cubing it or vice versa",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=4, rating_overall=4.57),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.5,
                                    ...
                                    correct_option="d",
                                    explanation_ar="Formula:\n Total surface area = 6 × Edge²\n\nSubstitution:\n        Area = 6 × 5² = 6 × 25 = 150 cm²\n\nWhy other options are wrong:\n            • (a) 1155 cm³: Result of Calculate Area of faces instead of 6 Lateral faces\n            • (b) 154 cm³: Result of confusing Volume and Total surface area\n            • (d) 462 cm³: Result of squaring Edge instead of cubing it or vice versa",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=5, rating_overall=4.71),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.6,
                                    ...
                                    correct_option="a",
                                    explanation_ar=" angle = 180 − 50 − 60 = 70°\nTherefore 90° → Acute triangle\n\nWhy other options are wrong:\n            • (b) Right Angle , 90°: Result of forgetting division by 2 in formula Area of Triangle\n            • (c) Angle , 70°: Result of using formula Rectangle without division by 2\n            • (d)Therefore , 80°: Result of adding Base and Height instead of multiplying them",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=5, rating_overall=4.71),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.6,
                                    ...
                                    correct_option="b",
                                    explanation_ar="Formula:\n Space diagonal of Cube = Edge × √3\n\nSubstitution:\n = 6 × √3 = 6√3 cm\n\nWhy other options are wrong:\n            • (b) 168 cm²: Result of Calculate Area of faces instead of 6 Lateral faces\n            • (c) 672 cm²: Result of confusing Volume and Total surface area\n            • (d) 62 cm²: Result of squaring Edge instead of cubing it or vice versa",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=5, rating_overall=4.71),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.6,
                                    ...
                                    correct_option="b",
                                    explanation_ar="Area ratio = Square Similarity ratio\n = (2/3)² = 4/9\n\n20 ÷ Area₂ = 4 ÷ 9\nArea₂ = 20 × 9 ÷ 4 = 45 cm²\n\nWhy other options are wrong:\n            • (a) 49 cm²: Result of using formula Perimeter instead of Area\n            • (c) 182 cm²: Result of forgetting sides in Calculate Area\n            • (d) 84 cm²: Result of error in Calculate",
        ...
        rating_clarity=5, rating_cognitive=4, rating_fairness=5, rating_distractors=5, rating_difficulty_align=4, rating_explanation=5, rating_discrimination=5, rating_overall=4.71),
                ...
                Question(skill_id="quant_geometry", question_type="geometry", difficulty=0.7,
                                    ...
                                    correct_option="b",
                                    explanation_ar="Formula:\n        = × ( − 3) ÷ 2\n\nSubstitution:\n = 9 × (9 − 3) ÷ 2\n = 9 × 6 ÷ 2 = 27\n\nWhy other options are wrong:\n            • (a) 5 cm: Result of error Calculation in calculation\n            • (c) 10 cm: Result of incorrectly applying formula\n            • (d) 10√2 cm: Result of forgetting sides calculation   ",
